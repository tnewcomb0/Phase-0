...
// I had some trouble with assigning the children object to terah. I just had to make the children object empty and then add into it in a different way than with the previous tests. You just have nested objects, you have to follow the control flow.
...
// I learned that I have to think of js in a much different way than I think of Ruby, gotta start wrapping my brain around new rules.
